...
const curatedProjects: ProjectItem[] = [
  ...
  },
  {
    ...
    category: 'Mobile',
    language: 'Dart',
    tags: ['Flutter', 'Google Play', 'CameraX', 'Dart', 'Material'],
    githubUrl: 'https://github.com/Dr-Rank1/QR-app',
    playStoreUrl: 'https://play.google.com/store/apps/details?id=com.dr_rank.qrcodescanner&hl=en_US',
    featured: true,
  },
  {
    ...
    playStoreUrl: 'https://play.google.com/store/apps/details?id=com.rank.quickpdf&hl=en_US',
    featured: true,
  },
  {
    id: 'temporary-email',
    ...
    description:
      'Android utility app delivering instant disposable email addresses with live mailbox syncing, attachment previewing, and zero registration requirements for high-privacy surfing.',
    category: 'Mobile',
    language: 'Kotlin',
    tags: ['Kotlin', 'Android', 'Retrofit', 'Coroutines', 'REST APIs'],
